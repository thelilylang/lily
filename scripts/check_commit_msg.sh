...
TOPICS="base|bin/ci|bin/lily|bin/lilyc|cli/lily|cli/lilyc|command/lily|command/lilyc|cc|cc/ci|cpp|ex|global|lib/builtin|lib/local|lib/std|lib/sys|lily|lily/analysis|lily/compiler|lily/diagnostic|lily/functions|lily/mir|lily/package|lily/parser|lily/precompiler|lily/preparser|lily/scanner|lily/shared|lsp|patches|scripts|shared"
