...
TOPICS="base|bin/ci|bin/cic|bin/lily|bin/lilyc|cli/ci|cli/cic|cli/lily|cli/lilyc|command/ci|command/cic|command/lily|command/lilyc|cc|cc/ci|cc/runtime|cpp|ex|global|lib/builtin|lib/cc|lib/local|lib/std|lib/sys|lily|lily/analysis|lily/compiler|lily/diagnostic|lily/functions|lily/mir|lily/package|lily/parser|lily/precompiler|lily/preparser|lily/scanner|lily/shared|lsp|patches|scripts|shared"
