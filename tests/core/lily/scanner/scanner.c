...
main()
{
    ...
    ADD_SUITE(17,
              ...
              CALL_CASE(literal_suffix_int32),
              CALL_CASE(literal_suffix_int64),
              CALL_CASE(literal_suffix_int8),
              CALL_CASE(literal_suffix_isize),
              CALL_CASE(literal_suffix_uint16),
